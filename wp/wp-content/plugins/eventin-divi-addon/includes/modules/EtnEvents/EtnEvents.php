...
class DIVI_EtnEvents extends ET_Builder_Module {

	public $slug       = 'eventin_events';
	...
	public function init() {
		$this->name = esc_html__( 'Eventin Events', 'eventin-divi-addon' );
	}
	...
	public function get_fields() {
		return array(
			...
			'__all_events' => array(
				'type' => 'computed',
				'computed_callback' => array( 'DIVI_EtnEvents', 'get_eventin_events' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$shortcode_content = do_shortcode("[events style ='{$style}' event_cat_ids = '{$category_terms}' event_tag_ids = '{$tag_terms}' order='{$order}' orderby='{$orderby}' filter_with_status='{$filter_status}' etn_event_col ='{$event_col}' limit = '{$event_count}' desc_limit='{$etn_desc_limit}']");
	...
	static function get_eventin_events( $agrs = array() ) {
		...
		echo do_shortcode("[events style ='{$style}' event_cat_ids = '{$category_terms}' event_tag_ids = '{$tag_terms}' order='{$order}' orderby='{$orderby}' filter_with_status='{$filter_status}' etn_event_col ='{$event_col}' limit = '{$event_count}' desc_limit='{$etn_desc_limit}']");
