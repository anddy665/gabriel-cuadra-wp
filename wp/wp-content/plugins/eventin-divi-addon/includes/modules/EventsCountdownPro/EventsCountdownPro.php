...
class DIVI_EventsCountdownpro extends ET_Builder_Module {

	public $slug       = 'eventin_events_countdown_pro';
	...
	public function init() {
		$this->name = esc_html__( 'Eventin Events CountDown Pro', 'eventin-divi-addon' );
	}
	...
	public function get_fields() {
		return array(
			...
			'__single_event' => array(
				'type' => 'computed',
				'computed_callback' => array( 'DIVI_EventsCountdownpro', 'get_eventin_events' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$shortcode_content = do_shortcode("[etn_pro_countdown event_id = {$etn_event_id}]");
	...
	static function get_eventin_events( $agrs = array() ) {
		...
		echo do_shortcode("[etn_pro_countdown event_id = {$etn_event_id}]");
