...
class DIVI_EventsSliderpro extends ET_Builder_Module
{

	public $slug       = 'eventin_events_slider_pro';
	...
	{
		$this->name = esc_html__('Events Slider Pro', 'eventin-divi-addon');
	}
	...
	public function get_fields()
	{
		return array(
			...
			'__all_events' => array(
				'type' => 'computed',
				'computed_callback' => array('DIVI_EventsSliderpro', 'get_eventin_events'),
	...
	public function render($attrs, $content, $render_slug)
	{
		...
		$event_slider_count = $this->props['event_slider_count'];
		...
		$shortcode_content = do_shortcode("[etn_pro_events_sliders style ='{$style}' event_cat_ids = '{$category_terms}' event_tag_ids = '{$tag_terms}' orderby='{$orderby}' order='{$order}' filter_with_status='{$filter_status}' event_count = '{$event_count}' event_slider_count = {$event_slider_count} desc_limit = {$etn_desc_limit}]");
	...
	static function get_eventin_events($agrs = array())
	{
		...
		$event_slider_count = $agrs['event_slider_count'];
		...
		echo do_shortcode("[etn_pro_events_sliders style ='{$style}' event_cat_ids = '{$category_terms}' event_tag_ids = '{$tag_terms}' orderby='{$orderby}' order='{$order}' filter_with_status='{$filter_status}' event_count = '{$event_count}' event_slider_count = {$event_slider_count} desc_limit = {$etn_desc_limit}]");
