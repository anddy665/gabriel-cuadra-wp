...
class DIVI_RecurringEvents extends ET_Builder_Module {

	public $slug       = 'eventin_recurring_events';
	...
	public function init() {
		$this->name = esc_html__( 'Recurring Events Pro', 'eventin-divi-addon' );
	}
	...
	public function get_fields() {
		return array(
			...
			'__single_event' => array(
				'type' => 'computed',
				'computed_callback' => array( 'DIVI_RecurringEvents', 'get_eventin_events' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$shortcode_content = do_shortcode("[etn_event_recurring single_event_ids = {$etn_event_id}]");

		return sprintf( "%s", $shortcode_content);
	...
	static function get_eventin_events( $agrs = array() ) {
		...
		echo do_shortcode("[etn_event_recurring single_event_ids = {$etn_event_id}]");
