...
class DIVI_ScheduleTabsPro extends ET_Builder_Module {

	public $slug       = 'eventin_schedule_tabs_pro';
	...
	public function init() {
		$this->name = esc_html__( 'Eventin schedule Tab Pro',  'eventin-divi-addon' );
	}
	...
	public function get_fields() {
		return array(
			...
			'__all_schedule' => array(
				'type' => 'computed',
				'computed_callback' => array( 'DIVI_ScheduleTabsPro', 'get_eventin_schedules' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$shortcode_content = do_shortcode("[etn_pro_schedules_tab order='{$order}' ids = {$schedule_ids}]");
	...
	static function get_eventin_schedules( $agrs = array() ) {
		...
		echo do_shortcode("[etn_pro_schedules_tab order='{$order}' ids = {$schedule_ids}]");
